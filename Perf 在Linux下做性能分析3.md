...
![img](./Perf 在Linux下做性能分析3.assets/9a1cce72e02b748c02d182d56dc5df40_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/a3d60ec6cceb2a5642a76697c81433c9_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/29a16c30ba1de309b967c6844a64f3cc_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/87497c2c59383521db47d950f1b67292_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/c47ea36e6a78cd96ec047c1605cac3e6_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/693557f52b128980964d799392cada1d_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/1fa34c856fead98cd9f1e3bbc57c8e29_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/8e98a335ece6fabb59f96dd735978e4b_720w.jpg)

大家注意一下Command那一列。那里已经不仅仅有cs这个进程了。

perf report是一个菜单接口，可以一直展开到每个函数的代码的，例如我们要展开上面这个heavy_cal()函数的具体计数，我们在上面回车，选择代码分析，我们可以得到：

![img](./Perf 在Linux下做性能分析3.assets/c09106dc4dcbad72e61a021ff6168a40_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/8a6b829532cf69b964da1192ee9672fc_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/208e1c43d41ade589998e35b224b12b0_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/64e0c0e19caa218771cb9ac6e795dc89_720w.jpg)

这种情况，abc击中了11次，def击中了6次，而ghi击中了1次。这样我们可以在一定程度上更容易判断瓶颈的位置。-g命令可以实现这样的跟踪，下面是一个例子：



![img](./Perf 在Linux下做性能分析3.assets/54cddcb2d899c330c45526f3253fc8fa_720w.jpg)
...
![img](./Perf 在Linux下做性能分析3.assets/6af084a5b368b4dcbccb9a957bf81f47_720w.jpg)
