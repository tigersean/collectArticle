...
![img](./现代网络负载均衡与代理导论.assets/network-lb-overview.png)
...
![img](./现代网络负载均衡与代理导论.assets/l4-termination-lb.png)
...
![img](./现代网络负载均衡与代理导论.assets/l7-termination-lb.png)
...
![img](./现代网络负载均衡与代理导论.assets/middle-proxy-lb.png)
...
![img](./现代网络负载均衡与代理导论.assets/edge-proxy-lb.png)
...
![img](./现代网络负载均衡与代理导论.assets/lb-via-client-lib.png)
...
![img](./现代网络负载均衡与代理导论.assets/lb-via-sidecar.png)
...
![img](./现代网络负载均衡与代理导论.assets/l4-passthrough-lb.png)
...
![img](./现代网络负载均衡与代理导论.assets/l4-dsr.png)
...
注意，不管是在 passthrough 还是 DSR 设计中，负载均衡器和后端之间的连接跟踪、NAT 、GRE 等等都有多种设置方式。但不幸的是这个话题超出本文的讨论范围。

### 4.5 通过 HA pair 实现容错

![img](./现代网络负载均衡与代理导论.assets/l4-fault-tolerance-via-ha.png)
...
![img](./现代网络负载均衡与代理导论.assets/l4-fault-tolerance-and-scaling-via-cluster.png)
...
![img](./现代网络负载均衡与代理导论.assets/twt-1.png)
...
![img](./现代网络负载均衡与代理导论.assets/global-lb.png)
...
![img](./现代网络负载均衡与代理导论.assets/twt-2.png)
